  ...
  <div>
    <div class="grid grid-cols-12 mt-8">
      <div class="col-span-12 lg:col-span-8 sm:col-span-12">
        <h2 class="text-lg font-medium truncate mr-5">Create New Project</h2>
      </div>
    </div>
          ...
          <div class="flex flex-wrap mb-6">
            <a-form layout="vertical" class="w-full">
              ...
              <div class="flex gap-x-5">
                <a-form-item label="Browse Logo (170x150)" class="flex-1">
                  <FileUpload
                    ref="bannerPond"
                    id="logo"
                    accept_file_types="image/jpeg, image/png"
                    label="Browse"
                    @removeFile="onRemoveFile($event, 'logo')"
                    max_file_size="1MB"
                ...
                <a-form-item label="Browse Cover Photo" class="flex-1">
                  <FileUpload
                    ref="coverPhotoPond"
                    id="cover_photo"
                    accept_file_types="image/jpeg, image/png"
                    label="Browse"
                    @removeFile="onRemoveFile($event, 'cover_photo')"
                    max_file_size="1MB"
              ...
              <a-form-item label="Active Status" class="w-1/2">
