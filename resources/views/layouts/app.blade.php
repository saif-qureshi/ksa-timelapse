...
<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="Midone - HTML Admin Template" class="w-6" src="{{ filled(settings()->get('logo')) ? asset(Storage::url(settings()->has('logo'))) : asset('dist/images/logo.svg') }}">
        </a>
    ...
    <div class="h-full flex items-center">
        ...
        <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
            <img alt="{{ config("app.name") }}" class="logo__image w-1/2"
                 src="{{ filled(settings()->get('logo')) ? asset(Storage::url(settings()->get('logo'))) : asset('dist/images/logo.svg') }}">
